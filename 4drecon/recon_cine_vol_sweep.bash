...
STACKS="../data/s*_rlt_ab_swp_resliced.nii.gz"
...
RESOLUTION=1.25
NMC=3 # TAR --- adjusted to 2 so that ITER = 3. ITER > 3 crashes MIRTK
NSR=10
NSRLAST=20
NUMCARDPHASE=25
...
CARDPHASESFILE="../cardsync/cardphases_swp_resliced_cardsync.txt"
